package io.github.subhamtyagi.quickcalculation.utils;

public class Utils {
    public static final String OPERATIONS = "operations";
    public static final String TIME = "time";
    public static final String LOWER_1 = "lower1";
    public static final String LOWER_2 = "lower2";
   ...
   /* public static int getTheme(Context context) {
        ...
        switch (name) {
            case "quick_calculation":
                return R.style.Theme_quick_calculation;
            case "purple":
            ...
            case "light_green":
                return R.style.Theme_light_green;
            case "dark":
